...
class SHA_DIAGONAL(nn.Module):
    ...
    def _kaiming_init(self, tensor: torch.Tensor):
    ...
    def _kaiming_normal(self, tensor: torch.Tensor, generator: torch.Generator):
